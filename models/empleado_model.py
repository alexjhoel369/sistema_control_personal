...
class Empleado(db.Model):
    ...
    materias_asignadas = db.relationship('Materia_asignada', back_populates='empleado', cascade='all, delete-orphan')
    ...
    def get_full_by_id(id):
        ...
        joinedload(Empleado.materias_asignadas),
        joinedload(Empleado.asistencias),
        joinedload(Empleado.permisos),
